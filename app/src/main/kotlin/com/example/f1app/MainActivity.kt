...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                val ingestor = Main(this as Context?)
...
fun F1AppApp() {
    ...
    NavigationSuiteScaffold(
        ...
        // This Scaffold now contains BOTH the Top Bar and the Content
        Scaffold(
            modifier = Modifier.fillMaxSize(),
            topBar = { LightsOutTopBar() } // Call your component here!
        ) { innerPadding ->
            // Use a Column or Box to handle the content based on navigation
...
enum class AppDestinations(
    ...
    //CHAMPIONSHIPS("Championships", R.drawable.ic_trophy)
}
